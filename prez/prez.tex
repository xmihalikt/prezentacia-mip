...
\title{{prezentacia čislo 234567890}
}
...
\begin{itemize}
\item Ešte pre prehľadom prezentácie sa zvyčajne uvádza motivácia.
\item Bežne sa aj tu používajú odrážky, ale tento text je naschvál uvedený bez odrážok.
	\begin{itemize}
	\item Niekedy môže byť potrebné uviesť aj citát
	\item Toto je len príklad slajdov. Ako urobiť dobrú prezentáciu bolo vysvetlené na prednáške.
	\end{itemize}
...
\includegraphics[scale=0.2]{obrazky/seo2.jpeg}
